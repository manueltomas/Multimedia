...
export const ANIMALS: Animal[] = [
    ...
    {id:3, name:'frog', description:'', imageUrl:'../assets/img/frog.png', catched:false, world:WORLDS[1].id, page:1, x:0.4855, y:0.3934},
    {id:4, name:'koala', description:'', imageUrl:'../assets/img/koala.png', catched:false, world:WORLDS[1].id, page:2, x:0.5914, y:0.5759},
