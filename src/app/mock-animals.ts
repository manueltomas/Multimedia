...
export const ANIMALS: Animal[] = [
    ...
    {id:2, name:'dog', description:'', imageUrl:'../assets/img/dog.png', catched:false, world:WORLDS[0].id, page:4},
    ...
    {id:6, name:'boar', description:'', imageUrl:'../assets/img/boar.png', catched:false, world:WORLDS[2].id, page:4},
  ];